...
public class Stages
{
     ...
     */
    public static void profile(MC x,MC y,MC z)
    {
        Scanner scan = new Scanner (System.in);
        System.out.println("Welcome. What would you like to do?");
        System.out.println("\nProfile (P)   |   Saving Account (S)   |   Deleting Account (D)   |   Power Points (PP)   |   Load Account (L)   \n\n");
        String response = scan.nextLine();
        if (response.equalsIgnoreCase("S")) //saves account
        {
            System.out.println("Processing..." + "\n");
            Methods.saveAccount(x,y,z);
        }
        else if (response.equalsIgnoreCase("D")) //delets account
        {
            System.out.println("Processing..." + "\n");
            Methods.eraseAccount(x,y);
            System.out.println("Complete." + "\n" + "\n");
        }
        else if (response.equalsIgnoreCase("PP")) //power points on to character
        {
            System.out.println("Processing..." + "\n");
        ...
        else if (response.equalsIgnoreCase("L")) //load accounts
        {
            System.out.println("Processing..." + "\n" + "\n");
            z = Methods.getAccounts(x,y,z);
        }
