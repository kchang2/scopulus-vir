...
{    
    ...
    static ArrayList <Object> chest = new ArrayList <Object> ();
    static MC hero = new MC ("player", 0, 0, 100, 10, 10, 10, 100, Weapon.fist, Armor.clothes, 0, 100, 1, 10, 5, 0, 0, 20, chest); //account current
