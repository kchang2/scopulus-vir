 ...
 */
public class MC extends Character implements Serializable
{
    int questNumber = 0;
    int level = 1;
    int max_hp = 10;
    ...
    ArrayList <Object> chest = new ArrayList <Object> ();
    Armor a = new Armor ("Clothes", 0, 0, 0, 0, 0, 0, 0, 0, 0, "basic armor");
    
    /**
     * Constructor class
     */
    public MC (String name, int questNumber, double experience, int current_hp, int agility, int defence, int strength, int money, Weapon w, Armor a, int level, int max_hp, int min_heal, int max_heal, int ppoints, double totalExperience, double totalCurrentExperience, int totalMoney, ArrayList <Object> chest)
    {
    ...
    public void setArmor(Armor x) //set armor of character
    {
        a = x;
    }
    ...
    public ArrayList <Object> getChest() //gets the chest list in return
    {
        return chest;
    }
    
    public void setChest(Object x) //sets the total experience character earns includeing deductions
    {
        chest.add(x);
    }
