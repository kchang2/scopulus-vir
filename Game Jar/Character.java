...
public abstract class Character
{
    ...
    Item weapon = new Item ("Fist", 0, 0, 0, 0, 0, 0, 0, 0, 0, "Basic weapon"); //orignal item they carry
    ...
    public Character(String name, double experience, int current_hp, int agility, int defence, int strength, int money, Item weapon)
    {
        this.name = name;
    ...
    public Item getWeapon() //gets the weapon of character
    {
        return weapon;
    }
    
    public void setWeapon(Item x) //sets the weapon of character
    {
        weapon = x;
    }
}
