...
public class Armor extends Item
{
     ...
     */
    public void buying(MC hero) //increases health, defence
    {
        ...
        while (loop == true)
        {
            ...
            System.out.println("\nQuest Armours:\n");
                for (Armor i : queststorage) //for loop
                {
                    if (hero.getQuestNumber() > i.getQuestNumber())
                    {   
                        armors.add(i); //puts the armor in the arraylist of possible armors to buy
