...
{
    int max_hp = 10;
    static Item armor = new Item ("Clothes", 0, 0, 0, 0, 0, 0, 0, 0, 0, "");
    int min_heal = 0;
    int max_heal = 0;
     ...
     */
    public Champion(String name, double experience, int current_hp, int agility, int defence, int strength, int money, Item weapon, Item armor, int max_hp,  int min_heal, int max_heal)
    {
    ...
    public void setArmor(Item x) //sets armor of character
    {
        armor = x;
    }
